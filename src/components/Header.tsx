    ...
    <>
      <nav className="w-full border-b">
        <div className="py-5 md:py-0 container mx-auto px-6 flex items-center justify-between">
          ...
          <button className="focus:outline-none lg:text-lg lg:font-bold focus:ring-2 focus:ring-offset-2 focus:ring-[#082491] hidden md:block bg-transparent transition duration-150 ease-in-out hover:bg-gray-200 rounded border border-[#082491] text-[#082491] px-4 sm:px-8 py-1 sm:py-3 text-sm">
            Sign in
          </button>
        </div>
      </nav>
